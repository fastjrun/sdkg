    ...
    extends BaseGenericClient
{
    ...
    public com.fastjrun.share.sdk.packet.generic.LoginRestResponseBody login(com.fastjrun.share.sdk.packet.generic.LoginRestRequestBody request) {
        StringBuilder sbUrlReq = new StringBuilder(this.genericUrlPre);
        sbUrlReq.append("/generic/user/");
    ...
    public com.fastjrun.share.sdk.packet.generic.LoginRestResponseBody loginv1_1(com.fastjrun.share.sdk.packet.generic.LoginRestRequestBody request) {
        StringBuilder sbUrlReq = new StringBuilder(this.genericUrlPre);
        sbUrlReq.append("/generic/user/");
