...
public class MethodGeneratorHelper {
    ...
    public static void processMethodCommonVariables(JCodeModel cmTest, JBlock methodTestBlk,
      JVar reqParamsJsonJVar, PacketField parameter) {
    ...
    private static void logResponseBodyField(JCodeModel cmTest, Logger log, int loopSeq,
      PacketObject responseBody, JVar responseBodyVar, JBlock methodTestBlk) {
    ...
    public static void logResponseBody(JCodeModel cmTest, Logger log, String packageNamePrefix,
      int loopSeq, PacketObject responseBody, JVar responseBodyVar, JBlock methodTestBlk) {
        ...
        if (robjects != null && robjects.size() > 0) {
            for (String reName : robjects.keySet()) {
                ...
                logResponseBody(cmTest, log, packageNamePrefix, loopSeq + start++, ro, reNameVar,
                  methodTestBlk);
            }
        }
        ...
        if (roLists != null && roLists.size() > 0) {
            ...
            for (String roName : roLists.keySet()) {
                ...
                logResponseBody(cmTest, log, packageNamePrefix, loopSeq + start++, ro,
