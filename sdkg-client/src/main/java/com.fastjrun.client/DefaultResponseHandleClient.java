...
public abstract class DefaultResponseHandleClient extends BaseResponseHandleClient<BaseHttpUtilClient> {

    // DefaultResponseHead
    @Override
    public <T extends BaseBody> T parseBodyFromResponse(JsonNode responseJsonObject, Class<T> valueType) {
            ...
            if (body != null) {
                try {
                    resObj = this.objectMapper
                            .readValue(body.toString(), valueType);
                } catch (IOException e) {
